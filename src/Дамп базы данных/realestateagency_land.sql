...
/*!40000 ALTER TABLE `land`
  DISABLE KEYS */;
INSERT INTO `land`
VALUES (1, 'Пенза', 'Аустрина', '15', '34', 57, 23, 99),
       (2, 'Пенза', 'Крымская', '28', '66', -79, 43, 134),
       (3, 'Пенза', 'Бакунина', '78', '34', 69, 31, 197),
       (5, 'Знаменск', 'Пионерская', '1', '10', 0, 3, 44),
       (8, 'пенза', 'советская', '1', '69', 14, 56, 98);
/*!40000 ALTER TABLE `land`
  ENABLE KEYS */;
UNLOCK TABLES;
