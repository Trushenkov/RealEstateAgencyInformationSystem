...
/*!40000 ALTER TABLE `flat`
  DISABLE KEYS */;
INSERT INTO `flat`
VALUES (1, 'Пенза', 'Беляева', '15', '34', 57, 23, 3, 5, 59),
       (2, 'Пенза', 'Пушкина', '26', '54', -79, 43, 5, 4, 44),
       (3, 'Пенза', 'Воронова', '3', '3435', 66, 44, 2, 4, 3);
/*!40000 ALTER TABLE `flat`
  ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-06-03 19:14:42
